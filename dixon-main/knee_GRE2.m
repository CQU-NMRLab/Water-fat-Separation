...
[coil1,seqParam1] = getKSpace1('Scanwxcge3dte24cor1.mrd');
[coil2,seqParam2] = getKSpace1('Scanwxcge3dte24cor2.mrd');
...
img1=rot90(img1,-2);
img2=rot90(img2,-2);
imgCo1=fliplr(rot90(imgCo1,-2));

[coil3,seqParam3] = getKSpace1('Scanwxcge3dte44cor1.mrd');
[coil4,seqParam4] = getKSpace1('Scanwxcge3dte44cor2.mrd');
...
img3=rot90(img3,-2);
img4=rot90(img4,-2);
imgCo4=fliplr(rot90(imgCo4,-2));

[coil5,seqParam5] = getKSpace1('Scanwxcge3dte64cor1.mrd');
[coil6,seqParam6] = getKSpace1('Scanwxcge3dte64cor2.mrd');
...
img5=rot90(img5,-2);
img6=rot90(img6,-2);
imgCo6=fliplr(rot90(imgCo6,-2));

%% Add priori phantom image k-space data
[coil7,seqParam7] = getKSpace1('Scanwxcge3dte24corphan1.mrd');
[coil8,seqParam8] = getKSpace1('Scanwxcge3dte24corphan2.mrd');
...
img7=rot90(img7,-2);
img8=rot90(img8,-2);
imgCo8=fliplr(rot90(imgCo8,-2));

[coil9,seqParam9] = getKSpace1('Scanwxcge3dte44corphan1.mrd');
[coil10,seqParam10] = getKSpace1('Scanwxcge3dte44corphan2.mrd');
...
img9=rot90(img9,-2);
img10=rot90(img10,-2);
imgCo10=fliplr(rot90(imgCo10,-2));

[coil11,seqParam11] = getKSpace1('Scanwxcge3dte64corphan1.mrd');
[coil12,seqParam12] = getKSpace1('Scanwxcge3dte64corphan2.mrd');
...
img11=rot90(img11,-2);
img12=rot90(img12,-2);
imgCo12=fliplr(rot90(imgCo12,-2));
