...
[coil1,seqParam1] = getKSpace1('Scan2FSE1.mrd');
[coil2,seqParam2] = getKSpace1('Scan2FSE2.mrd');
...
[coil3,seqParam3] = getKSpace1('ScanFSE2-20ms1.mrd');
[coil4,seqParam4] = getKSpace1('ScanFSE2-20ms2.mrd');
...
[coil5,seqParam5] = getKSpace1('ScanFSE2-40ms1.mrd');
[coil6,seqParam6] = getKSpace1('ScanFSE2-40ms2.mrd');
...
[coil7,seqParam7] = getKSpace1('Scan1-corrent1.mrd');
[coil8,seqParam8] = getKSpace1('Scan1-corrent2.mrd');
...
[coil9,seqParam9] = getKSpace1('Scan1-corrent-20ms1.mrd');
[coil10,seqParam10] = getKSpace1('Scan1-corrent-20ms2.mrd');
...
[coil11,seqParam11] = getKSpace1('Scan1-corrent-40ms1.mrd');
[coil12,seqParam12] = getKSpace1('Scan1-corrent-40ms2.mrd');
...
DATA=cat(3,S1,S2,S3);
TE1=str2num(seqParam1.tRgs)*1e-3;
TE2=str2num(seqParam3.tRgs)*1e-3;
TE3=str2num(seqParam5.tRgs)*1e-3;
TE=[TE1,TE2,TE3];
[r2s,t2s, s0] = R2star_ARLO_mag(DATA,TE); % ARLO calculates R2*map

SS1=(abs(S1).*exp((angle(Sp1)-angle(S1))*1i)).*exp(TE1*r2s); 
SS3=(abs(S3).*exp((angle(Sp3)-angle(S3))*1i)).*exp(TE3*r2s); % Eq. 2
